...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        val ivPriorityItem = itemView.findViewById<ImageView>(R.id.item_priority_level)
        val tvMinute = itemView.findViewById<TextView>(R.id.pager_tv_minutes)
